...
src/
  ...
  components/game/              # игровой экран (Figma 1:90), панель ставки (1:493)
                                # и оверлеи win (1:462) / big win (1:202)
...
настройки (модалка поверх меню), колесо — Wheel of Luck, Play — сам слот. Переключатели
в настройках живут в локальном стейте: сохранения ещё нет.
